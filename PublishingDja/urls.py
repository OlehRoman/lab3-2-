...
urlpatterns = [
    ...
    path('api/network/products', views.get_all_products_net),
    path('api/network/product/<int:id>', views.get_product_net),
    path('api/network/product/delete/<int:id>', views.delete_product_net),
    path('objects/', views.object_list_view, name="object_list"),
    path('objects/delete/<int:id>/', views.delete_object, name="delete_object"),
]
